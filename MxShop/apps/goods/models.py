...
class GoodsCategory(models.Model):
    ...
    # 设置models 有一个指 向自己的外键
    parent_categroy = models.ForeignKey(
        # 外键指向自己
        "self", on_delete=models.CASCADE, null=True, blank=True, verbose_name="父类目录级别", help_text="父目录", related_name="sub_cat")
...
class Goods(models.Model):
    ...
    sold_num = models.IntegerField("商品销量数", default=0)
    ...
    goods_desc = models.TextField(verbose_name=u"内容",  default='')
    shop_free = models.BooleanField("是否承担运费", default=True)
