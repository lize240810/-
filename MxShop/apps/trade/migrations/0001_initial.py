    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='商品时间')),
            ],
            options={
                'verbose_name': '订单商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nonce_str', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='随机加密字符串')),
                ...
                ('order_money', models.FloatField(default=0.0, verbose_name='订单金额')),
