...
# get_user_model 回去寻找setting中的 auth_user_model
...
class OrderInfo(models.Model):
	...
	# 微信支付会用到
	nonce_str = models.CharField("随机加密字符串", max_length=50, null=True, blank=True, unique=True)
	# 支付宝交易号
...
class OrderGoods(models.Model):
	...
	# 两个外键形成一张关联表
	goods = models.ForeignKey(Goods, on_delete=models.CASCADE, verbose_name="商品")
	good_nums = models.IntegerField("商品数量", default=0)

	add_time = models.DateTimeField("商品时间", default=datetime.now)
